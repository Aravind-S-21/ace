        ...
        <div className="w-full max-w-sm">
          <div className="bg-white rounded-xl border border-border p-6 shadow-sm">
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-text-secondary mt-1">Start discovering AI-matched opportunities</p>
            </div>

            <form className="space-y-4" onSubmit={handleSubmit}>
              <Input label="Full Name" placeholder="Alex Sharma" required />
              <Input label="Email" type="email" placeholder="alex@example.com" required />
              <Input label="College" placeholder="IIT Madras" required />
