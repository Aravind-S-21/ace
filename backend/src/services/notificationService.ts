...
import { ScoringEngine } from '../ml/scoringEngine';
...
export class NotificationService {
  ...
  public async generateDeadlineNotificationsForStudent(studentId: string | bigint): Promise<number> {
  ...
  public async triggerRecommendationNotificationsForNewEvent(eventId: string | bigint): Promise<number> {
